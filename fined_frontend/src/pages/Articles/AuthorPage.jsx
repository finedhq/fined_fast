          ...
          <div className="ap-author-hero-inner">
            ...
            <div className="ap-author-text">
              ...
              <div className="ap-author-bio-wrap">
                <a href={author?.linkedin_url || "https://www.linkedin.com/in/shravan-mutha-302247297/"} target="_blank" rel="noopener noreferrer" className="ap-author-linkedin">
                ...
                <a href="mailto:shravanmutha45@gmail.com" target="_blank" rel="noopener noreferrer" className="ap-author-linkedin" style={{ color: '#333' }}>
